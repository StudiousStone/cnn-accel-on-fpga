...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/fpdiv14_memoryC0_uid146_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fpdiv14_memoryC0_uid147_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fpdiv14_memoryC1_uid150_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fpdiv14_memoryC1_uid151_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fpdiv14_memoryC2_uid154_invTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fpdiv14.vo"
fi
