...
# ACDS 15.1 185 win32 2016.05.04.16:38:04
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If fpdiv14 is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/fpdiv14_memoryC0_uid146_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fpdiv14_memoryC0_uid147_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fpdiv14_memoryC1_uid150_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fpdiv14_memoryC1_uid151_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fpdiv14_memoryC2_uid154_invTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fpdiv14.vo"
}
