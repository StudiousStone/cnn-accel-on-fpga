...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_mm_slave_bfm.sv" -work mm_slave_bfm_0            -cdslib ./cds_libs/mm_slave_bfm_0.cds.lib           
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/avlon_MM_slave.v"                                                                                                             
fi
